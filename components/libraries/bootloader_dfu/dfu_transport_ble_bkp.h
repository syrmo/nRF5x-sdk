...
#ifndef DEVICE_NAME
  #define DEVICE_NAME                          "DFUSyrmo"                                               /**< Name of device. Will be included in the advertising data. */
#endif

#ifndef MANUFACTURER_NAME
  #define MANUFACTURER_NAME                    "Syrmo Inc."                                   /**< Manufacturer. Will be passed to Device Information Service. */
#endif
...
#define APP_ADV_INTERVAL                     MSEC_TO_UNITS(35, UNIT_0_625_MS)                        /**< The advertising interval (25 ms.). */
...
#define APP_IMAGE_SIZE_OFFSET                8
